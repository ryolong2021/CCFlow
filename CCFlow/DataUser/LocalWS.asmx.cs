...
namespace CCFlow.DataUser
{
    ...
    public class LocalWS : System.Web.Services.WebService
    {
        ...
        public string DB_RunSQLReturnJSON(string sqlOfSelect, string password)
        {
            ...
            // return BP.Tools.Json.ToJson(dt);
            throw new Exception("err@この方法を実装してください。パスワード部分は両方の当事者によって合意されており、一般には公開されません。.");
        }
        /// <summary>
        /// 创建WorkID
        /// </summary>
        ...
        {
            GenerWorkFlow gwf = new GenerWorkFlow(workid);
              BP.WF.Dev2Interface.WriteTrackWorkCheck(gwf.FK_Flow, gwf.FK_Node, gwf.WorkID, gwf.FID, msg, "審査");
        }
        /// <summary>
        /// 是否可以查看该工作
        /// </summary>
