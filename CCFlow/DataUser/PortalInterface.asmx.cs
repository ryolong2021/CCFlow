...
namespace ccbpm
{
    ...
    public class PortalInterface : System.Web.Services.WebService
    {
        ...
        public int CheckUserNoPassWord(string userNo, string password)
        {
            ...
            {
                throw new Exception("@検証エラー：" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单Demo
        }
        /// <summary>
        ...
        public DataTable GetDept(string deptNo)
        {
            ...
            {
                throw new Exception("@部門の取得にエラーが発生しました:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetStations()
        {
            ...
            {
                throw new Exception("@役職の取得中にエラーが発生しました:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetEmps()
        {
            ...
            {
                throw new Exception("@人員情報を取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetDeptEmp()
        {
            ...
            {
                throw new Exception("@部門の人員情報を取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetEmpHisDepts(string empNo)
        {
            ...
            {
                throw new Exception("@人員の部門エンティティ情報を取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetEmpHisStations(string empNo)
        {
            ...
            {
                throw new Exception("@人員の役職の情報を取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GetDeptEmpStations()
        {
            ...
            {
                throw new Exception("@部門担当者の対応する情報を取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        ...
        public DataTable GenerEmpsByStations(string stationNos)
        {
            ...
            {
                throw new Exception("@ポスト収集によると、スタッフ収集エラーを取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        /// <summary>
        ...
        public DataTable GenerEmpsByDepts(string deptNos)
        {
            ...
            {
                throw new Exception("@部署収集によると、人員収集エラーを取得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        ...
        public DataTable GenerEmpsBySpecDeptAndStats(string deptNo, string stations)
        {
            ...
            {
                throw new Exception("@ 指定部門と一つの部署が集まって、彼らの人員を獲得する:" + ex.Message); //连接错误，直接抛出异常.
            }
            #endregion 简单 Demo
        }
        #endregion
