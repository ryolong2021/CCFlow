...
namespace BP.WF.HttpHandler
{
    public class WF_Admin_DevelopDesigner : BP.WF.HttpHandler.DirectoryPageBase
    {
        ...
        {
            //删除html
            string filePath = BP.Sys.SystemConfig.PathOfDataUser + "CCForm" + Path.DirectorySeparatorChar + "HtmlTemplateFile" + Path.DirectorySeparatorChar + this.FK_MapData + ".htm";
