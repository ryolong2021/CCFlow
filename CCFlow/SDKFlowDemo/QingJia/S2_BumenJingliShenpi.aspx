<%@ Page Title="" Language="C#" MasterPageFile="~/SDKFlowDemo/QingJia/Site1.Master" AutoEventWireup="true" CodeBehind="S2_BumenJingliShenpi.aspx.cs" Inherits="CCFlow.SDKFlowDemo.QingJia.S2_BumenJingliShenpi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        ...
        <asp:TextBox ID="TB_BMNote" TextMode="MultiLine" runat="server" Height="93px" Width="682px"></asp:TextBox>
    </fieldset>
