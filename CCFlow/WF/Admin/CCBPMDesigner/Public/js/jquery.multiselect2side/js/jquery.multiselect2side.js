				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							:
							("<p class='AddOne' title='選択'><i class='icon-chevron-left'></i></p>" +
							"<p class='AddAll' title='全選択'><i class='icon-backward'></i></p>" +
							"<p class='RemoveOne' title='削除'><i class='icon-chevron-right'></i></p>" +
							"<p class='RemoveAll' title='クリア'><i class='icon-forward'></i></p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
