...
function Connector(startPoint, endPoint, type, id) {
    ...
    * It can be one of: 's0', 's1_1', 's2_2', etc. */
    ...
    this.properties.push(new BuilderProperty('線属性設定', 'group', BuilderProperty.TYPE_GROUP_LABEL));
    ...
    this.properties.push(new BuilderProperty('厚さ', 'style.lineWidth', BuilderProperty.TYPE_LINE_WIDTH));
    //this.properties.push(new BuilderProperty('Line Style','style.lineStyle', BuilderProperty.TYPE_LINE_STYLE));
    this.properties.push(new BuilderProperty('色', 'style.strokeStyle', BuilderProperty.TYPE_COLOR));
