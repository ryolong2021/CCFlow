...
var col4Html = '';
col4Html += '<center><h3>ユニバーサル4列モード</h3>';
...
col4Html += '</tr>';
col4Html += '<tr>';
col4Html += '    <td >申請者部门</td>';
col4Html += '    <td colspan=3></td>';
col4Html += '</tr>';

col4Html += '<tr>';
col4Html += '    <td  >フィールド1</td>';
col4Html += '    <td style=width:30% ></td>';
col4Html += '    <td  >フィールド2</td>';
col4Html += '    <td  style=width:30% ></td>';
col4Html += '</tr>';

col4Html += '<tr>';
col4Html += '    <td  >フィールド3</td>';
col4Html += '    <td style=width:30% ></td>';
col4Html += '    <td  >フィールド4</td>';
col4Html += '    <td  style=width:30% ></td>';
col4Html += '</tr>';
...
var col6Html = '';
col6Html += '<center><h3>ユニバーサル6カラムモード</h3>';
...
col6Html += '<tr>';
col6Html += '    <td>フィールド1</td>';
col6Html += '    <td></td>';
col6Html += '    <td>フィールド2</td>';
col6Html += '    <td></td>';
col6Html += '    <td>フィールド3</td>';
col6Html += '    <td></td>';
col6Html += '</tr>';

col6Html += '<tr>';
col6Html += '    <td>フィールド4</td>';
col6Html += '    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>';
col6Html += '    <td>フィールド5</td>';
col6Html += '    <td>&nbsp;&nbsp;&nbsp;</td>';
col6Html += '    <td>フィールド6</td>';
col6Html += '    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>';
col6Html += '</tr>';
