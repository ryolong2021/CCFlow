...
function UpdateStatus(msgConfirm, ConfirmYesFun) {
    ...
    html+="         <a href='#' class='ui-btn ui-corner-all ui-btn-inline ui-btn-b ullabel optionConfirm' data-rel='back' style='width: 33%;border-radius: 5px;height: 30px;line-height: 30px;padding: 0;margin: 0 0 0 12%;'>確定</a>";
    html+= "        <a href='#' class='ui-btn ui-corner-all ui-btn-inline ui-btn-b ullabel optionCancel' data-rel='back' style='width: 33%;border-radius: 5px;height: 30px;line-height: 30px;padding: 0;margin: 0 0 0 5%;'>キャンセル</a>";
    html+="     </div>";
    html+="</div>";
