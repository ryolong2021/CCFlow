...
function RefBill(frmID) {
    ...
    OpenBootStrapModal(url, "eudlgframe", "関連レシート", W, H, "icon-property", null, null, null, function () {
...
function ShowRefBillInfo(frmID) {
    ...
    OpenBootStrapModal(url, "eudlgframe", "関連レシート情報", W, H, "icon-property", null, null, null, null, null, "black"); 
}
...
function PrintHtml() {
    ...
    OpenBootStrapModal(url, "eudlgframe", "PDF印刷", W, H, "icon-property", null, null, null, null, null, "black");
}
...
function PrintPDF() {
    ...
    OpenBootStrapModal(url, "eudlgframe", "PDF印刷",600, 500, "icon-property", null, null, null, null, null, "black");
