...
jBoxConfig.languageDefaults = {
    close: '閉じる', /* 窗口右上角关闭按钮提示 */
    ok: '確定', /* $.jBox.prompt() 系列方法的“确定”按钮文字 */
    yes: 'はい', /* $.jBox.warning() 方法的“是”按钮文字 */
    no: 'いいえ', /* $.jBox.warning() 方法的“否”按钮文字 */
    cancel: 'キャンセル' /* $.jBox.confirm() 和 $.jBox.warning() 方法的“取消”按钮文字 */
};
