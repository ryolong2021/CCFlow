...
jBoxConfig.languageDefaults = {
    close: '閉じる', /* 窗口右上角閉じる按钮提示 */
    ok: 'を選択します', /* $.jBox.prompt() 系列方法的“を選択します”按钮文字 */
    yes: 'はい、', /* $.jBox.warning() 方法的“はい、”按钮文字 */
    no: 'いいえ、', /* $.jBox.warning() 方法的“いいえ、”按钮文字 */
    cancel: 'キャンセル' /* $.jBox.confirm() 和 $.jBox.warning() 方法的“キャンセル”按钮文字 */
};
