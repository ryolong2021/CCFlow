...
function InitPage() {
    ...
    $.each(tks, function () {
        ...
        if (this.IsDoc == "1" && isReadonly == false) {
            ...
            html += "</select><font color=Gray>内容は2000字を超えてはなりません</font>";
            html += "</div>";
        ...
        for (var idx = 0; idx < SignType.length; idx++) {
            ...
            if (st.SignType == 0 || st.SignType == 2 || st.SignType == null) {
                ...
                html += "<td style='text-align:left;height:35px;line-height:35px;'><div style='float:left'><font color='Gray' >署名:</font>"
                    ...
                    + "<div style='float:right' ><font color='Gray' >日付:</font>" + (IsDoc ? "<span id='rdt'>" : "") + rdt + (IsDoc ? "</span>" : "") + "</div></td>";
                html += "</tr>";
                break;
            }
            ...
            if (st.SignType == 3) {
                ...
                html += +" <div style='float:right' ><font color='Gray' >日付:</font>" + (IsDoc ? "<span id='rdt'>" : "") + rdt + (IsDoc ? "</span>" : "") + "</div></td>";
                html += "</tr>";
                break;
            }
        }
