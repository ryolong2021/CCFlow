...
function createonevent() {
    ...
    $("#help-opener").on("click", function () {
        var modalHelp = $("#modal-help")[0].__component;
        modalHelp.opened = !0;
    ...
    window.onload = function () {
        ...
        // プルダウンリスト
        wfCommon.initDropdown(true, dtKbn["DEAD_KBN"], "11", MT_KBN_KEYVALUE, MT_KBN_KEYNAME, "something2","pulltest2");

        // 画面表示
        var fmodal = $("#full-modal")[0].__component;
        fmodal.opened = !0;
        fmodal.onCloseRequested = function () {
            //wfCommon.ShowDialog(DIALOG_CONFIRM, "中止しますか？", "お申込手続きを終了します。 入力内容は保存されません。 よろしいでしょうか？ このページから移動してもよろしいですか？", null, cancelok);
            wfCommon.ShowDialog(DIALOG_INFO, "否認の処理", "伝票番号：XXXXXXXXXXXXXXXXXX", null, cancelok);
        }
    }
...
function setdateitems() {
    ...
    wfCommon.setdatepicker("#datetest", null, true, false);
    wfCommon.setdatepicker("#datetest0", "HH時mm分", false, true);
    wfCommon.setdatepickerWithStartEnd("#datetest002", "#datetest003", null, true, false);
    wfCommon.setdatepickerWithStartEnd("#datetest004", "#datetest005", null, true, false, function () { }, function () { });
}
