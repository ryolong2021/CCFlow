...
namespace BP.DA
{
    ...
    public class DataType
    {
        ...
        {
            if (dt.Length <= 6)
                throw new Exception("@変換するシーズンの日付形式が正しくありません:" + dt);
        ...
        public static void WriteFile(string file, string Doc)
        {
            ...
            {
                throw new Exception("@ファイル：" + file + ",エラー:" + ex.Message);
            }
        ...
        public static string ReadURLContext(string url, int timeOut, Encoding encode)
        {
            ...
            catch (Exception ex)
            {
                try
                {
                    BP.DA.Log.DefaultLogWriteLineWarning("@URLの読み取りエラー：URL=" + url + "@エラーメッセージ：" + ex.Message);
                    return null;
                }
                catch
                {
            ...
            catch (Exception ex)
            {
                ...
                {
                    // 如果出现死连接。
                    BP.DA.Log.DefaultLogWriteLineWarning("@取得のURL=" + url + "失敗。例外情報:" + ex.Message, true);
                    return null;
                }
                catch
                {
        ...
        public static string TurnToFiels(float money)
        {
            ...
            switch (je.Length)
            {
                ...
                case 4: // 元;
                    ...
                    break;
                default:
                    throw new Exception("これほどの金額は放送されていません");
            }
        ...
        public static int SpanQuarter(string _APFrom, string _APTo)
        {
            ...
            int i = 0;
            if (fromdate > todate)
                throw new Exception("選択エラー！開始時期" + _APFrom + "は終了時期" + _APTo + "より大きくしてはいけません!");
        ...
        public static string ParseStringToPinyin(string exp)
        {
            ...
            //特殊处理. 
            exp = exp.Replace("単価", "DanJia");
            exp = exp.Replace("1件", "DanJian");
            exp = exp.Replace("シングル", "DanGe");
        ...
        public static string ParseStringToPinyinWordFirst(string str)
        {
            ...
            {
                throw new Exception("@エラー：" + str + "、ピンインに変換できません。");
            }
        }
        /// <summary>
        /// 转化成拼音第一个字母大字
        ...
        {
            if (exp.Trim() == "")
                throw new Exception("DataType.ParseExpToDecimal変換する式が空です。");
            ...
            catch (Exception ex)
            {
                if (exp.IndexOf("/") != -1)
                    return 0;
                throw new Exception("表現式(\"" + exp + "\")計算エラー：" + ex.Message);
            }
        }
        ...
        public static string GetJDByMM(string mm)
        {
            ...
            switch (mm)
            {
                ...
                case "12":
                    ...
                    break;
                default:
                    throw new Exception("@有効な月の形式ではありません" + mm);
            }
            return jd;
        }
        /// <summary>
        ...
        public static string CurrentDataTimeCNOfShort
        {
            get
            {
                return DateTime.Now.ToString("yy年MM月dd日 HH時mm分");
            }
        }
        public static string CurrentDataTimeCNOfLong
        {
            get
            {
                return DateTime.Now.ToString("yy年MM月dd日 HH時mm分ss秒");
            }
        }
        ...
        public static string ParseSysDateTime2SysDate(string sysDateformat)
        {
            ...
            {
                throw new Exception("日付の形式が間違っています:" + sysDateformat + " errorMsg=" + ex.Message);
            }
        }
        /// <summary>
        /// 转化为友好的日期
        ...
        public static DateTime ParseSysDate2DateTime(string sysDateformat)
        {
            ...
            {
                throw new Exception("日付[" + sysDateformat + "]変換エラー:" + ex.Message + "無効な日付は書式です。");
            }
            //return dt;			 
        }
        /// <summary>
        ...
        public static DateTime ParseSysDateTime2DateTime(string sysDateformat)
        {
            ...
            {
                throw new Exception("@時間の形式が正しくありません:" + sysDateformat + "@技術情報:" + ex.Message);
            }
        }
        ...
        public static DBUrlType GetDBUrlByString(string strDBUrl)
        {
            switch (strDBUrl)
            {
                ...
                default:
                    throw new Exception("@そのようなタイプはありません[" + strDBUrl + "]");
            }
        }
        public static int GetDataTypeByString(string datatype)
        {
            switch (datatype)
            {
                ...
                default:
                    throw new Exception("@そのようなタイプはありません" + datatype);
            }
        }
            ...
            if (Web.WebUser.SysLang == "CH")
            {
                switch (datatype)
                {
                    ...
                    case DataType.AppString:
                        return "文字(nvarchar)";
                    default:
                        throw new Exception("@そのようなタイプはありません");
                }
            }
        ...
        public static bool StringToBoolean(string str)
        {
            ...
            else if (str == "はい" || str == "いいえ")
            {
                ...
                throw new Exception("@変換される[" + str + "]ブール型ではない");
