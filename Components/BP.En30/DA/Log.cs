...
namespace BP.DA
{
	...
	public class Log
	{
        ...
        public static void ClearLog()
        {
            try
            {
                File.Delete(BP.Sys.SystemConfig.PathOfLog + DateTime.Now.ToString(Path.DirectorySeparatorChar + "yyyy_MM_dd.log"));
            }
            catch
            {
            }
		...
		public static string GetLogFileName()
		{
			...
			return filepath + Path.DirectorySeparatorChar + DateTime.Now.ToString("yyyy_MM_dd") + ".log";

			//return filepath + Path.DirectorySeparatorChar + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + ".log";
		}
		/// <summary>
		/// 写一行日志
		/// </summary>
...
//			string stub = DateTime.Now.ToString("@HH:MM:ss") ;
			string stub = DateTime.Now.ToString("dd日HH時mm分ss秒") ;
			switch(logtype) 
			{
				case LogType.Info:
					stub += "Info:";
        ...
        public static void OpenLogDir()
        {
            ...
            {
                throw new Exception("@ログディレクトリを開くときにエラーが発生しました。" + ex.Message);
            }
        }
        /// <summary>
        /// 打开今天的日志
        ...
        public static void OpeLogToday()
        {
            ...
            {
                throw new Exception("@ログファイルを開くときにエラーが発生しました。"+ex.Message );
            }
        }
