...
namespace BP.En
{
    ...
    public class AttrsOfSearch : System.Collections.CollectionBase
    {
        ...
        {
            AttrOfSearch aos = new AttrOfSearch("Form_" + refKey, lab + "から", refKey, ">=", defaultvalueOfFrom, tbWidth, false);
            aos.SymbolEnable = false;
            this.InnerList.Add(aos);

            AttrOfSearch aos1 = new AttrOfSearch("To_" + refKey, "まで", refKey, "<=", defaultvalueOfTo, tbWidth, false);
