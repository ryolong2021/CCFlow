    ...
    public class ClassFactory 
    {
        ...
        public static bool LoadConfig(string cfgFile)
        {
            ...
            if (!File.Exists(cfgFile))
                throw new Exception("構成ファイルが見つかりませんでした[" + cfgFile + "]2");
            ...
            {
                throw new Exception("設定ファイル[" + cfgFile + "]を読み込みに失敗しました。\n" + ex.Message + "起動に失敗しました。");
            }
        ...
        public static void SetValue(object obj, string propertyName, object val)
        {
            ...
            if (p == null)
                throw new Exception("属性値の設定に失敗しました！種類[" + tp + "]属性なし[" + propertyName + "]");
        ...
        public static object GetValue(object obj, string propertyName)
        {
            ...
            PropertyInfo p = tp.GetProperty(propertyName);
            if (p == null)
                throw new Exception("属性値の取得に失敗しました！種類[" + tp + "]属性なし[" + propertyName + "]");
        ...
        static ClassFactory()
        {
            ...
            if (Directory.Exists(path + "bin" + Path.DirectorySeparatorChar))
            {
                if (!DataType.IsNullOrEmpty(SystemConfig.AppSettings["CCFlowAppPath"]) && Directory.Exists(path + SystemConfig.AppSettings["CCFlowAppPath"] + "bin" + Path.DirectorySeparatorChar))
                {
                    _BasePath = path + SystemConfig.AppSettings["CCFlowAppPath"] + "bin" + Path.DirectorySeparatorChar;
                }
                else
                {
                    _BasePath = path + "bin" + Path.DirectorySeparatorChar;
                }
            }
            else
            {
            ...
            get
            {
                if (_BasePath == null)
                {
                    if (SystemConfig.AppSettings["InstallPath"] == null)
                        _BasePath = "D:" + Path.DirectorySeparatorChar;
                    else
        ...
        public static ArrayList GetBPTypes(string baseEnsName)
        {
            ...
            if (baseClass == null)
            {
                throw new Exception("@タイプが見つかりません:" + baseEnsName + "！");
            }
            return arr;
        ...
        public static object GetObject_OK(string className)
        {
            if (className == "" || className == null)
                throw new Exception("@変換するクラス名が空です。");
