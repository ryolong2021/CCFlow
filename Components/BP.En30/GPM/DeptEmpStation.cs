    ...
    public class DeptEmpStation : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "対応する部門スタッフ";

              //  map.AddMyPK();

                map.AddTBStringPK("MyPK", null, "主キーMyPK", false, true, 1, 150, 10);


                map.AddTBString(DeptEmpStationAttr.FK_Dept, null, "部門", false, false, 1, 50, 1);
                map.AddTBString(DeptEmpStationAttr.FK_Station, null, "役職", false, false, 1, 50, 1);
                map.AddTBString(DeptEmpStationAttr.FK_Emp, null, "オペレーター", false, false, 1, 50, 1);
