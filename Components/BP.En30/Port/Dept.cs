    ...
    public class Dept : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(DeptAttr.No, null, "ナンバリング", true, false, 1, 50, 20);
                map.AddTBString(DeptAttr.Name, null, "名前", true, false, 0, 100, 30);
                map.AddTBString(DeptAttr.ParentNo, null, "親ノード番号", true, true, 0, 100, 30);
                map.AddTBInt(DeptAttr.Idx, 0, "シリアルナンバー", false, true);
        ...
        public override int Retrieve()
        {
            if (BP.Sys.SystemConfig.OSDBSrc == OSDBSrc.WebServices)
            {
                ...
                if (dt.Rows.Count == 0)
                    throw new Exception("@番号(" + this.No + ")の部門が存在しません。");
