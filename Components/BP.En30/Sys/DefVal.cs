    ...
    public class DefVal : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_UserRegedit", "語彙を選択してください");
                ...
                map.AddTBString(DefValAttr.FK_MapData, null, "エンティティ", false, false, 0, 100, 20);
                map.AddTBString(DefValAttr.FK_Emp, null, "人員", false, true, 0, 100, 10);
                map.AddTBString(DefValAttr.AttrKey, null, "ノード対応フィールド", false, false, 0, 50, 20);

                //map.AddTBInt(DefValAttr.WordsSort, 0, "词汇类型", false, false);//1,2,3... 退回-移交-表单...(暂时)
                map.AddTBInt(DefValAttr.LB, 0, "カテゴリー", false, false);//我的，历史,系统，
                map.AddTBString(DefValAttr.CurValue, null, "テキスト", false, true, 0, 4000, 10);
