    ...
    public class EnVer : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "エンティティのバージョン番号"; //  实体的描述.
                ...
                map.AddMyPK();
                map.AddTBString(EnVerAttr.No, null, "エンティティークラス", true, false, 1, 50, 20);
                map.AddTBString(EnVerAttr.Name, null, "エンティティ名", true, false, 0, 100, 30);
                map.AddTBString(EnVerAttr.PKValue, null, "主キー値", true, true, 0, 300, 100);
                map.AddTBInt(EnVerAttr.EVer, 1, "バージョンナンバ", true, true);
                map.AddTBString(EnVerAttr.Rec, null, "更新者", true, true, 0, 100, 30);
                map.AddTBDateTime(EnVerAttr.RDT, null, "更新日", true, true);
