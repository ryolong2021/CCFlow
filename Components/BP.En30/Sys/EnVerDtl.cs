    ...
    public class EnVerDtl : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_EnVerDtl", "エンティティ変更明細");
                ...
                map.AddMyPK();
                map.AddTBString(EnVerDtlAttr.EnName, null, "エンティティ名", true, false, 0, 200, 30);
                map.AddTBString(EnVerDtlAttr.EnVerPK, null, "バージョンマスターPK", false, false, 0, 100, 100);
                map.AddTBString(EnVerDtlAttr.AttrKey, null, "フィールド", false, false, 0, 100, 1);
                map.AddTBString(EnVerDtlAttr.AttrName, null, "フィールド名", true, false, 0, 200, 30);
                map.AddTBString(EnVerDtlAttr.OldVal, null, "古い値", true, false, 0, 100, 30);
                map.AddTBString(EnVerDtlAttr.NewVal, null, "新しい値", true, false, 0, 100, 30);
                //map.AddTBString(EnVerDtlAttr.EnNo, null, "选中行编号", true, false, 0, 100, 30);
                map.AddTBInt(EnVerDtlAttr.EnVer, 1, "バージョン番号（日付）", true, false);

                map.AddTBDateTime(EnVerDtlAttr.RDT, null, "日付", true, false);
                map.AddTBString(EnVerDtlAttr.Rec, null, "バージョンナンバー", true, false, 0, 100, 30);
