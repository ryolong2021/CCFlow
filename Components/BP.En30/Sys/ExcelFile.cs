    ...
    public class ExcelFile : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "Excelテンプレート";

                map.AddTBStringPK(ExcelFileAttr.No, null, "ナンバリング", true, true, 1, 36, 200);
                map.AddTBString(ExcelFileAttr.Name, null, "名前", true, false, 1, 50, 100, true);
                map.AddTBString(ExcelFileAttr.Mark, null, "ロゴ", true, false, 1, 50, 100);
                map.AddDDLSysEnum(ExcelFileAttr.ExcelType, 0, "種類", true, true, ExcelFileAttr.ExcelType, "@0=一般的なファイルデータの抽出@ 1 =フロー添付データの抽出");
                map.AddTBStringDoc(ExcelFileAttr.Note, null, "アップロード説明", true, false, true);

                map.AddSearchAttr(ExcelFileAttr.ExcelType);

                map.AddMyFile("テンプレートファイル", "*.xls|*.xlsx");
