    ...
    public class ExcelSheet : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(ExcelSheetAttr.Name, null, "Sheet名前", true, false, 1, 50, 100);
                map.AddDDLEntities(ExcelSheetAttr.FK_ExcelFile, null, "Excelテンプレート", new ExcelFiles(), true);
                map.AddTBInt(ExcelSheetAttr.SheetIndex, 0, "Sheetインデックス", true, false);
