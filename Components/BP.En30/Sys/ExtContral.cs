    ...
    public class ExtContral : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_MapAttr", "拡張コントロール");
                ...
                map.AddTBString(MapAttrAttr.DefVal, null, "デフォルト值", false, false, 0, 4000, 20);

                map.AddTBInt(MapAttrAttr.UIContralType, 0, "コントロール", true, false);
                map.AddTBInt(MapAttrAttr.MyDataType, 0, "データのタイプ", true, false);
                ...
                map.AddTBInt(MapAttrAttr.MinLen, 0, "最小の長さ", true, false);
                map.AddTBInt(MapAttrAttr.MaxLen, 300, "最大長", true, false);
                ...
                map.AddBoolean(MapAttrAttr.UIIsEnable, true, "有効にするかどうか", true, true);
                map.AddBoolean(MapAttrAttr.UIIsLine, false, "別の列に表示するかどうか", true, true);
                map.AddBoolean(MapAttrAttr.UIIsInput, false, "必須フィールドかどうか", true, true);
                ...
                map.AddTBString(MapAttrAttr.Tag, null, "識別（一時データを保存）", true, false, 0, 100, 20);
                map.AddTBInt(MapAttrAttr.EditType, 0, "編集タイプ", true, false);

                //单元格数量。2013-07-24 增加。
                map.AddTBString(MapAttrAttr.ColSpan, "1", "セルの数", true, false, 0, 3, 3);
