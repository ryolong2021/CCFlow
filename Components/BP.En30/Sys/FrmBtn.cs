    ...
    public class FrmBtn : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(FrmBtnAttr.UACContext, null, "制御内容", true, false, 0, 3900, 20);

                map.AddTBInt(FrmBtnAttr.EventType, 0, "イベントタイプ", false, false);
                map.AddTBString(FrmBtnAttr.EventContext, null, "イベント内容", true, false, 0, 3900, 20);

                map.AddTBString(FrmBtnAttr.MsgOK, null, "実行に成功しました提示", true, false, 0, 500, 20);
                map.AddTBString(FrmBtnAttr.MsgErr, null, "実行に失敗しました提示", true, false, 0, 500, 20);

                map.AddTBString(FrmBtnAttr.BtnID, null, "ボタンID", true, false, 0, 128, 20);

                map.AddTBInt(FrmBtnAttr.GroupID, 0, "所属グループ", false, false);
