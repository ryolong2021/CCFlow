    ...
    public class FrmEle : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_FrmEle", "フォーム要素の拡張");
                ...
                map.AddTBString(FrmEleAttr.FK_MapData, null, "フォームID", true, false, 1, 100, 20);
                map.AddTBString(FrmEleAttr.EleType, null, "種類", true, false, 0, 50, 20);
                map.AddTBString(FrmEleAttr.EleID, null, "コントロールID値（一部のコントロールで有効）", true, false, 0, 50, 20);
                map.AddTBString(FrmEleAttr.EleName, null, "コントロール名（一部のコントロールで有効）", true, false, 0, 200, 20);
                ...
                #region 参数.
                map.AddTBString(FrmEleAttr.Tag1, null, "リンクURL", true, false, 0, 50, 20);
                ...
                #region 控制属性.
                map.AddTBInt(FrmEleAttr.IsEnable, 1, "有効にするかどうか", false, false);
                #endregion 控制属性.
