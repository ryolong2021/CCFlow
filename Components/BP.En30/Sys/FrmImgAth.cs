    ...
    public class FrmImgAth : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_FrmImgAth", "画像添付ファイル");
                ...
                map.AddTBString(FrmImgAthAttr.FK_MapData, null, "フォームID", true, false, 1, 100, 20);
                map.AddTBString(FrmImgAthAttr.CtrlID, null, "コントロールID", true, false, 0, 200, 20);
                ...
                map.AddTBInt(FrmImgAthAttr.IsEdit, 1, "編集できるかどうか", true, true);
                map.AddTBInt(FrmImgAthAttr.IsRequired, 0, "必須項目かどうか", true, true);
