    ...
    public class FrmImgAthDB : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_FrmImgAthDB", "カット画像添付データ保存");

                map.Java_SetDepositaryOfEntity(Depositary.None);
                map.Java_SetDepositaryOfMap( Depositary.Application);
                map.EnDesc = "カット画像添付データ保存";
                ...
                map.AddTBString(FrmImgAthDBAttr.FK_MapData, null, "フォームID", true, false, 1, 100, 20);
                map.AddTBString(FrmImgAthDBAttr.FK_FrmImgAth, null, "画像添付番号", true, false, 1, 50, 20);
                map.AddTBString(FrmImgAthDBAttr.RefPKVal, null, "エンティティ主キー", true, false, 1, 50, 20);

                map.AddTBString(FrmImgAthDBAttr.FileFullName, null, "ファイルパス", true, false, 0, 700, 20);
                map.AddTBString(FrmImgAthDBAttr.FileName, null, "名前", true, false, 0, 500, 20);
                map.AddTBString(FrmImgAthDBAttr.FileExts, null, "拡張子名", true, false, 0, 50, 20);
                map.AddTBFloat(FrmImgAthDBAttr.FileSize, 0, "ファイルサイズ", true, false);

                map.AddTBDateTime(FrmImgAthDBAttr.RDT, null, "記録日", true, false);
                map.AddTBString(FrmImgAthDBAttr.Rec, null, "記録者", true, false, 0, 50, 20);
                map.AddTBString(FrmImgAthDBAttr.RecName, null, "レコーダーの名前", true, false, 0, 50, 20);
                map.AddTBStringDoc(FrmImgAthDBAttr.MyNote, null, "備考", true, false);
