    ...
    public class FrmLab : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_FrmLab", "ラベル");
                ...
                map.AddTBInt(FrmLabAttr.FontSize, 12, "フォントサイズ", false, false);
                map.AddTBString(FrmLabAttr.FontColor, "black", "色", true, false, 0, 50, 20);
                map.AddTBString(FrmLabAttr.FontName, null, "フォント名", true, false, 0, 50, 20);
                map.AddTBString(FrmLabAttr.FontStyle, "normal", "フォントスタイル", true, false, 0, 200, 20);
                map.AddTBString(FrmLabAttr.FontWeight, "normal", "フォント幅", true, false, 0, 50, 20);

                map.AddTBInt(FrmLabAttr.IsBold, 0, "太字かどうか", false, false);
                map.AddTBInt(FrmLabAttr.IsItalic, 0, "イタリック体かどうか", false, false);
