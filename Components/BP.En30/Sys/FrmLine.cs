    ...
    public class FrmLine : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_FrmLine", "ライン");
                ...
                map.AddMyPK();
                map.AddTBString(FrmLineAttr.FK_MapData, null, "マスタ", true, false, 0, 100, 20);
                ...
                map.AddTBFloat(FrmLineAttr.BorderWidth, 1, "幅", false, false);
                map.AddTBString(FrmLineAttr.BorderColor, "black", "色", true, false, 0, 30, 20);

                map.AddTBString(FrmLineAttr.GUID, null, "初期GUID", true, false, 0, 128, 20);
                this._enMap = map;
                return this._enMap;
            }
        }
