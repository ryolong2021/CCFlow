    ...
    public class FrmTree : EntityTree
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_FormTree", "フォームツリー");
                ...
                map.AddTBStringPK(FrmTreeAttr.No, null, "ナンバリング", true, true, 1, 10, 20);
                map.AddTBString(FrmTreeAttr.Name, null, "名前", true, false, 0, 100, 30);
                map.AddTBString(FrmTreeAttr.ParentNo, null, "親ノードNo", false, false, 0, 100, 30);
                map.AddTBString(FrmTreeAttr.OrgNo, null, "組織番号", false, false, 0, 100, 30);
