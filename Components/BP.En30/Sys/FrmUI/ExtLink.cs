    ...
    public class ExtLink : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_MapAttr", "ハイパーリンク");
                ...
                #region 个性化属性.
                map.AddTBString(MapAttrAttr.Name, "New Link", "ラベル", true, false, 0, 500, 20, true);
                map.AddTBString(MapAttrAttr.Tag1, "_blank", "接続ターゲット(_blank,_parent,_self)", true, false, 0, 20, 20);
