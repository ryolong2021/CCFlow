    ...
    public class FrmImgAth : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_FrmImgAth", "添付画像");
                ...
                map.AddTBString(FrmImgAthAttr.FK_MapData, null, "フォームID", true, true, 1, 100, 20);
                map.AddTBString(FrmImgAthAttr.CtrlID, null, "コントロールID", true, true, 0, 200, 20);
                map.AddTBString(FrmImgAthAttr.Name, null, "日本語の名前", true, false, 0, 200, 20);
                ...
                map.AddBoolean(FrmImgAthAttr.IsEdit, true, "編集可能かどうか", true, true);
                //map.AddTBInt(FrmImgAthAttr.IsEdit, 1, "是否可编辑", true, true);
                map.AddBoolean(FrmImgAthAttr.IsRequired, false, "必須項目かどうか", true, true);
