    ...
    public class MapAttrSFSQL : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_MapAttr", "外部データソース");
                ...
                map.AddDDLSysEnum(MapAttrAttr.LGType, 4, "種類", false, false);
                ...
                //默认值.
                map.AddTBString(MapAttrAttr.UIBindKey, null, "外部キーSFTable", true, true, 0, 100, 20);
                ...
                map.AddBoolean(MapAttrAttr.UIVisible, true, "見える", true, false);
                map.AddBoolean(MapAttrAttr.UIIsEnable, true, "編集できますか？", true, true);
