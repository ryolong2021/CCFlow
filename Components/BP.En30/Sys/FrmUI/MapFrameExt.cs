    ...
    public class MapFrameExt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(MapFrameAttr.UrlSrcType, 0, "URLソース", true, true, MapFrameAttr.UrlSrcType,
                    "@0=Custom @1=Map @2=Process trajectory table @3=Process trajectory diagram");
                ...
                map.AddTBString(FrmEleAttr.EleType, null, "の種類", false, false, 0, 50, 20, true);
