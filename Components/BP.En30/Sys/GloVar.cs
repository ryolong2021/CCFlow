    ...
    public class GloVar : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(GloVarAttr.Val, null, "値", true, false, 0, 4000, 20,true);
                map.AddTBString(GloVarAttr.GroupKey, null, "グループ値", true, false, 0, 120, 20, true);
                map.AddTBStringDoc(GloVarAttr.Note, null, "説明", true, false,true);
