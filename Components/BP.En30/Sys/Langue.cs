    ...
    public class Langue : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_Langue", "言語定義");
                map.Java_SetDepositaryOfMap(Depositary.Application);
                map.AddMyPK();

                map.AddTBString(LangueAttr.Langue, null, "言語ID", true, true, 0, 20, 20);

                map.AddTBString(LangueAttr.Model, null, "モジュール", true, true, 0, 20, 20);
                map.AddTBString(LangueAttr.ModelKey, null, "モジュールインスタンス", true, true, 0, 200, 20);

                map.AddTBString(LangueAttr.Sort, null, "種別", true, true, 0, 20, 20);
                map.AddTBString(LangueAttr.SortKey, null, "種別PK", true, true, 0, 100, 20);

                map.AddTBString(LangueAttr.Val, null, "言語の値", true, true, 0, 3999, 20);
