    ...
    public class MapDataTemplate : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_MapData", "フォームテンプレートテーブル");
                ...
                #region 基础信息.
                map.AddTBStringPK(MapDataTemplateAttr.No, null, "ナンバリング", true, false, 1, 150, 100);
                map.AddTBString(MapDataTemplateAttr.Name, null, "記述", true, false, 0, 200, 20);
                map.AddTBString(MapDataTemplateAttr.PTable, null, "物理的なテーブル", true, false, 0, 100, 20);
                map.AddTBInt("IsTemplate", 0, "フォームテンプレートかどうか", true, false);
                #endregion 基础信息.
