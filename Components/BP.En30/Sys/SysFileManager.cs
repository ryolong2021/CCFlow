    ...
    public class SysFileManager : EntityOID
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_FileManager", "ファイル管理");

                map.AddTBIntPKOID();
                map.AddTBString(SysFileManagerAttr.AttrFileName, null, "名前指定", true, false, 0, 50, 20);
                map.AddTBString(SysFileManagerAttr.AttrFileNo, null, "番号指定", true, false, 0, 50, 20);

                map.AddTBString(SysFileManagerAttr.EnName, null, "関連テーブル", false, true, 1, 50, 20);
                map.AddTBString(SysFileManagerAttr.RefVal, null, "主キー値", false, true, 1, 50, 10);
                map.AddTBString(SysFileManagerAttr.WebPath, null, "Web経路", false, true, 0, 100, 30);
                ...
                map.AddTBString(SysFileManagerAttr.RDT, null, "アップロード時間", true, true, 1, 50, 20);
                map.AddTBString(SysFileManagerAttr.Rec, null, "アップローダー", true, true, 0, 50, 20);
                map.AddTBStringDoc();
                this._enMap = map;
                return this._enMap;
            }
