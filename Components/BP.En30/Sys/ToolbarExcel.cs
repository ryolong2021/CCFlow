    ...
    public class ToolbarExcel : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_MapData","ToolbarExcel機能制御");

                map.Java_SetDepositaryOfEntity( Depositary.Application);
                map.Java_SetDepositaryOfMap( Depositary.Application);

                map.AddTBStringPK(MapDataAttr.No, null, "フォーム番号", true, false, 1, 200, 20);
                ...
                map.AddTBString(ToolbarExcelAttr.OfficeSaveLab, "保存", "ラベルを保存", true, false, 0, 50, 10);
                map.AddBoolean(ToolbarExcelAttr.OfficeSaveEnable, true, "有効にするかどうか", true, true);

                map.AddTBString(ToolbarExcelAttr.OfficeAcceptLab, "改訂を承認", "改訂ラベルを承認", true, false, 0, 50, 10);
                ...
                map.AddTBString(ToolbarExcelAttr.OfficeOverLab, "赤いボタン", "赤いラベルボタン", true, false, 0, 50, 10);
                ...
                map.AddTBString(ToolbarExcelAttr.OfficePrintLab, "印刷ボタン", "印刷ラベルボタン", true, false, 0, 50, 10);
