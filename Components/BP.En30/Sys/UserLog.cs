	...
	public class UserLog: EntityMyPK
	{
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_UserLogT", "ユーザーログ");
                ...
                map.AddTBString(UserLogAttr.FK_Emp, null, "ユーザー", true, false, 0, 30, 20);
                map.AddTBString(UserLogAttr.IP, null, "IP", true, false, 0, 200, 20);
                map.AddTBString(UserLogAttr.LogFlag, null, "ロゴ", true, false, 0, 300, 20);
                map.AddTBString(UserLogAttr.Docs, null, "説明", true, false, 0, 300, 20);
                map.AddTBString(UserLogAttr.RDT, null, "記録日", true, false, 0, 20, 20);
