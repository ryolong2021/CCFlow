    ...
    public class UserRegedit : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("Sys_UserRegedit", "ユーザーレジストリ");
                ...
                map.AddMyPK();
                map.AddTBString(UserRegeditAttr.FK_Emp, null, "ユーザー", false, false, 0, 30, 20);
                map.AddTBString(UserRegeditAttr.CfgKey, null, "キー", true, false, 0, 200, 20);
                map.AddTBString(UserRegeditAttr.Vals, null, "値", true, false, 0, 2000, 20);
                ...
                map.AddTBString(UserRegeditAttr.NumKey, null, "分析の鍵", true, false, 0, 300, 20);
                ...
                map.AddBoolean(UserRegeditAttr.IsPic, false, "画像かどうか", true, false);

                map.AddTBString(UserRegeditAttr.DTFrom, null, "クエリ時間", true, false, 0, 20, 20);
                map.AddTBString(UserRegeditAttr.DTTo, null, "まで", true, false, 0, 20, 20);
