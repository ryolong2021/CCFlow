    ...
    public class Bar : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(BarAttr.No, null, "ナンバリング", true, false, 1, 200, 200);
                map.AddTBString(BarAttr.Name, null, "名前", true, false, 0, 3900, 20);

                map.AddTBString(BarAttr.Title, null, "タイトル", true, false, 0, 3900, 20);
                ...
                map.AddDDLSysEnum(BarAttr.OpenWay, 0, "開く方式", true, true, BarAttr.OpenWay, "@0=新しいウィンドウ@1=このウィンドウ@2=新しいウィンドウを上書き");
                map.AddBoolean(BarAttr.IsLine, false, "1行を独占要否", true, true);
                ...
                map.AddTBString(BarAttr.MoreUrl, null, "その他のタグURL", true, false, 0, 3900, 20,true);
