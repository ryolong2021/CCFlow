    ...
    public class BarEmp : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(BarEmpAttr.FK_Bar, null, "情報ブロック番号", true, false, 0, 90, 20);
                map.AddTBString(BarEmpAttr.FK_Emp, null, "人員番号", true, false, 0, 90, 20);
                map.AddTBString(BarEmpAttr.Title, null, "タイトル", true, false, 0, 3900, 20);
                map.AddTBInt(BarEmpAttr.IsShow, 1, "表示要否", false, true);
                map.AddTBInt(BarEmpAttr.Idx, 0, "表示順", false, true);
