    ...
    public class App : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(AppAttr.No, null, "ナンバリング", true, false, 2, 30, 100);
                map.AddDDLSysEnum(AppAttr.AppModel, 0, "アプリケーションタイプ", true, true, AppAttr.AppModel, "@0=BSSystem @ 1 = CSシステム");
                map.AddTBString(AppAttr.Name, null, "名前", true, false, 0, 3900, 150, true);
                map.AddDDLEntities(AppAttr.FK_AppSort, null, "カテゴリー", new AppSorts(), true);
                map.AddBoolean(AppAttr.IsEnable, true, "有効要否", true, true);

                map.AddTBString(AppAttr.Url, null, "デフォルトの接続", true, false, 0, 3900, 100, true);
                map.AddTBString(AppAttr.SubUrl, null, "2番目の接続", true, false, 0, 3900, 100, true);
                map.AddTBString(AppAttr.UidControl, null, "ユーザー名制御", true, false, 0, 100, 100);
                map.AddTBString(AppAttr.PwdControl, null, "パスワード管理", true, false, 0, 100, 100);
                map.AddDDLSysEnum(AppAttr.ActionType, 0, "提出の種類", true, true, AppAttr.ActionType, "@0=GET@1=POST");
                map.AddDDLSysEnum(AppAttr.SSOType, 0, "ログイン方法", true, true, AppAttr.SSOType, "@0=SIDVerification @1= Connect @2= Form submission @3= No value");
                map.AddDDLSysEnum(AppAttr.OpenWay, 0, "開く方式", true, true, AppAttr.OpenWay,
                    "@0=新しいウィンドウ@1=このウィンドウ@2=新しいウィンドウを上書き");

                map.AddTBString(AppAttr.RefMenuNo, null, "関連メニュー番号", true, false, 0, 3900, 100);
                map.AddTBString(AppAttr.AppRemark, null, "備考", true, false, 0, 500, 500,true);
                map.AddTBInt(AppAttr.Idx, 0, "表示順", true, false);
                map.AddMyFile("ICON");
                ...
                rm = new RefMethod();
                rm.Title = "システムにアクセスできるユーザーを確認する";
