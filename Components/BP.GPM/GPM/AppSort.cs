    ...
    public class AppSort : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(AppSortAttr.No, null, "ナンバリング", true, true, 2, 2, 20);
                map.AddTBString(AppSortAttr.Name, null, "名前", true, false, 0, 300, 20);
                map.AddTBInt(AppSortAttr.Idx, 0, "表示順", true, false);
                map.AddTBString(AppSortAttr.RefMenuNo, null, "関連メニュー番号", false, false, 0, 300, 20);
        ...
        protected override bool beforeDelete()
        {
            ...
            if (pps.Count != 0)
                throw new Exception("err@このカテゴリにはシステムがあります。削除できません。このシステムカテゴリの下のシステムを削除または削除してください。このカテゴリを削除できます。");
