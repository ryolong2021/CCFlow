    ...
    public class GPMEmp : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                #region 字段
                /*关于字段属性的增加 */
                map.AddTBStringPK(EmpAttr.No, null, "ログインアカウント", true, false, 1, 50, 100);
                map.AddTBString(EmpAttr.Name, null, "名前", true, false, 0, 200, 100);
                ...
                map.AddTBString(EmpAttr.PinYin, null, "ピンイン", true, false, 0, 500, 132, true);
                ...
                map.AttrsOfOneVSM.AddBranches(new EmpMenus(), new BP.GPM.Menus(),
                   ...
                   BP.GPM.EmpMenuAttr.FK_Menu, "人員メニュー", EmpAttr.Name, EmpAttr.No, "0");
