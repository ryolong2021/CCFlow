    ...
    public class GroupEmp : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "権利グループの担当者";
                map.EnType = EnType.App;

                map.AddTBStringPK(GroupEmpAttr.FK_Group, null, "権利グループ", true, false, 0, 50, 20);
                map.AddDDLEntitiesPK(GroupEmpAttr.FK_Emp, null, "人員", new Emps(), true);
