    ...
    public class GroupMenu : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "権限グループメニュー";
                map.EnType = EnType.Sys;

                map.AddTBStringPK(GroupMenuAttr.FK_Group, null, "権利グループ", false, false, 0, 50, 20);
                map.AddTBStringPK(GroupMenuAttr.FK_Menu, null, "メニュー", false, false, 0, 50, 20);
                map.AddBoolean(GroupMenuAttr.IsChecked, true, "選択要否", true, true);
                this._enMap = map;
                return this._enMap;
            }
        }
