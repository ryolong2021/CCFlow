    ...
    public class GroupStation : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "権限グループの役職";
                map.EnType = EnType.Sys;

                map.AddTBStringPK(GroupStationAttr.FK_Group, null, "権利グループ", false, false, 0, 50, 20);
                map.AddDDLEntitiesPK(GroupStationAttr.FK_Station, null, "役職", new Stations(), true);
