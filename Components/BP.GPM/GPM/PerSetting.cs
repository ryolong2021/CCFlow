    ...
    public class PerSetting : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(PerSettingAttr.FK_Emp, null, "人事", true, false, 0, 200, 20);
                map.AddTBString(PerSettingAttr.FK_App, null, "システム", true, false, 0, 200, 20);
                ...
                map.AddTBInt(PerSettingAttr.Idx, 0, "表示順", false, true);
