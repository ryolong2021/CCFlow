    ...
    public class StationExt : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Port_Station","役職");
                ...
                map.AddTBStringPK(StationAttr.No, null, "ナンバリング", true, true, 4, 4, 36);
                map.AddTBString(StationAttr.Name, null, "名前", true, false, 0, 100, 200);
                map.AddDDLEntities(StationAttr.FK_StationType, null, "種類", new StationTypes(), true);
                map.AddTBString(StationAttr.OrgNo, null, "所属機関", true, false, 0, 50, 250);
                ...
                map.AttrsOfOneVSM.AddBranches(new StationMenus(), new BP.GPM.Menus(),
                   ...
                   BP.GPM.StationMenuAttr.FK_Menu, "バインドメニュー", EmpAttr.Name, EmpAttr.No, "0");
