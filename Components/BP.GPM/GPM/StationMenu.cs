    ...
    public class StationMenu : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLEntitiesPK(StationMenuAttr.FK_Station, null, "役職", new Stations(), true);
                map.AddTBStringPK(StationMenuAttr.FK_Menu, null, "メニュー", false, false, 0, 50, 20);
                map.AddBoolean(StationMenuAttr.IsChecked, true, "選択要否", true, true);
                this._enMap = map;
                return this._enMap;
            }
        }
