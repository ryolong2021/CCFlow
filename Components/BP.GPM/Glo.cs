...
namespace BP.GPM
{
    public class Glo
    {
        ...
        public static void DoInstallDataBase()
        {
            ...
            #region 3, 执行基本的 sql
            string sqlscript = SystemConfig.PathOfWebApp + Path.DirectorySeparatorChar + "GPM" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "Port_Inc_CH_BPM.sql";
            ...
            {
                sqlscript = SystemConfig.PathOfWebApp + Path.DirectorySeparatorChar + "GPM" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "InitPublicData.sql";
                BP.DA.DBAccess.RunSQLScript(sqlscript);
            }
            #endregion 初始化数据

            #region 6, 创建视图。
            sqlscript = SystemConfig.PathOfWebApp + Path.DirectorySeparatorChar + "GPM" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "MSSQL_GPM_VIEW.sql";

            //MySQL 语法有所区别
            if (BP.Sys.SystemConfig.AppCenterDBType == DBType.MySQL)
                sqlscript = SystemConfig.PathOfWebApp + Path.DirectorySeparatorChar + "GPM" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "MySQL_GPM_VIEW.sql";

            //Oracle 语法有所区别
            if (BP.Sys.SystemConfig.AppCenterDBType == DBType.Oracle)
                sqlscript = SystemConfig.PathOfWebApp + Path.DirectorySeparatorChar + "GPM" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "Oracle_GPM_VIEW.sql";
