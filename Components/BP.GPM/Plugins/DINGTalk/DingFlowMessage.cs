        ...
        public Ding_Post_ReturnVal Ding_SendWorkMessage(DingMsgType msgType, long WorkID, string sender)
        {
            ...
            switch (msgType)
            {
                case DingMsgType.text:
                    ...
                    msgText.content = title + "\n送信者：" + sender + "\n時間：" + BP.DA.DataType.CurrentDataTimeCNOfShort;
                ...
                case DingMsgType.OA:
                    ...
                    foreach (string user in users)
                    {
                        ...
                        hs.Add("フロー名",flowName);
                        hs.Add("現在のノード", nodeName);
                        hs.Add("申請者", starterName);
                        hs.Add("申請時間",rdt);
                        msgOA.body_form = hs;
                    ...
                    {
                        postVal.errcode = "500";
                        postVal.errmsg = faildSend + "メッセージの送信が失敗しました";
                    }
                    return postVal;
            }
            return null;
