    ...
    public class EmpApp : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "管理者とシステムの権限";
                map.EnType = EnType.App;

                map.AddMyPK();

                map.AddTBString(EmpAppAttr.FK_Emp, null, "オペレーター", true, false, 0, 50, 20);
                map.AddTBString(EmpAppAttr.FK_App, null, "システム", true, false, 0, 50, 20);

                map.AddTBString(AppAttr.Name, null, "システム名", true, false, 0, 3900, 20);
