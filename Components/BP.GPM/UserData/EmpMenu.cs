    ...
    public class EmpMenu : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(EmpMenuAttr.FK_Menu, null, "メニュー", false, false, 0, 50, 20);
                map.AddDDLEntitiesPK(EmpMenuAttr.FK_Emp, null, "メニュー機能", new BP.Port.Emps(), true);

                map.AddBoolean(EmpMenuAttr.IsChecked, true, "選択要否", true, true);
