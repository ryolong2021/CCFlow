    ...
    public class VGPMEmpMenu : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.EnDesc = "スタッフメニュー対応";
                map.EnType = EnType.View;

                map.AddMyPK();

                map.AddTBString(VGPMEmpMenuAttr.FK_Emp, null, "オペレーター", true, false, 0, 30, 20);
                map.AddTBString(VGPMEmpMenuAttr.FK_Menu, null, "メニュー機能", true, false, 0, 30, 20);

                map.AddTBString(MenuAttr.Name, null, "メニュー機能名", true, false, 0, 3900, 20);
                map.AddTBString(MenuAttr.ParentNo, null, "ParentNo", true, false, 1, 30, 20);
                map.AddTBString(AppAttr.Url, null, "接続", true, false, 0, 3900, 20, true);
                map.AddDDLSysEnum(MenuAttr.MenuType, 0, "メニュータイプ", true, true, MenuAttr.MenuType,
                    "@3=カタログ@4=関数@5=関数制御点");
                map.AddTBString(MenuAttr.FK_App, null, "システム", true, false, 0, 30, 20);
                map.AddMyFile("アイコン");
