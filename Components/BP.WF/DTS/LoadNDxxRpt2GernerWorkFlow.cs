...
namespace BP.WF.DTS
{
    ...
    public class LoadNDxxRpt2GernerWorkFlow : Method
    {
        ...
        {
            this.Title = "完了したフローデータをWF_GenerWorkflowにロードします（拡張フローデータのアップグレードが完了したモードでは、古いデータでは確認できない問題があります。）";
            this.Help = "拡張フローデータのアップグレードが完了したモードでは、古いデータでは確認できない問題があります。";
