...
namespace BP.WF.DTS
{
    ...
    public class RepariDB : Method
    {
        ...
        public RepariDB()
        {
            this.Title = "データベースを修復する";
            this.Help = "最新バージョンと現在のデータテーブル構造の自動修復を行います。修復の内容：欠落している列、欠落している列のコメント、不完全または変更された列のコメント。";
            this.Help += "<br>フォームデザイナのエラーにより、欠落しているフィールドを自動的に修復できます。";
            this.Help += "<br><a href='/'>フローデザイナーを入力してください</a>";
        }
        /// <summary>
        /// 设置执行变量
        /// </summary>
