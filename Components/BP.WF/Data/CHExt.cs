    ...
    public class CHExt : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(CHAttr.Title, null, "タイトル", true, true, 0, 900, 5,true);

                map.AddDDLEntities(CHAttr.FK_Flow, null, "フロー", new Flows(), false);

                map.AddTBString(CHAttr.FK_NodeT, null, "ノード名", true, true, 0, 50, 5);

                map.AddTBString(CHAttr.DTFrom, null, "時間から", true, true, 0, 50, 5);
                map.AddTBString(CHAttr.DTTo, null, "まで", true, true, 0, 50, 5);
                map.AddTBString(CHAttr.SDT, null, "予定完了日", true, true, 0, 50, 5);

                map.AddTBString(CHAttr.TimeLimit, null, "締め切り", true, true, 0, 50, 5);

                map.AddTBString(CHAttr.UseDays, null, "時間コスト", true, true, 0, 50, 5);
                map.AddTBString(CHAttr.OverDays, null, "期限切れ", true, true, 0, 50, 5);
                 
                map.AddDDLSysEnum(CHAttr.CHSta, 0, "状態", true, true, CHAttr.CHSta,
                    "@0=時間内に完了しました@1=時間どおりに完了しました@2=期限切れで完了しました@3=期限切れで完了しました");

                map.AddDDLEntities(CHAttr.FK_Dept, null, "所属部署", new BP.Port.Depts(), false);
                map.AddDDLEntities(CHAttr.FK_Emp, null, "当事者", new BP.Port.Emps(), false);
                map.AddTBString(CHAttr.FK_NY, null, "月", true, true, 0, 50, 5);
