    ...
    public class CHNode : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_CHNode", "ノードの時間制限");

                map.AddTBInt(CHNodeAttr.WorkID, 0, "WorkID", true, true);
                map.AddTBInt(CHNodeAttr.FK_Node, 0, "ノード", true, true);
                map.AddTBString(CHNodeAttr.NodeName, null, "ノードの名前", true, true, 0, 50, 5);

                map.AddTBString(CHAttr.FK_Emp, null, "処理者", true, true, 0, 30, 3);
                map.AddTBString(CHAttr.FK_EmpT, null, "処理者の名前", true, true, 0, 200, 5);

                map.AddTBString(CHNodeAttr.StartDT, null, "計画開始時間", true, true, 0, 50, 5);
                map.AddTBString(CHNodeAttr.EndDT, null, "計画終了時間", true, true, 0, 50, 5);
                map.AddTBInt(CHNodeAttr.GT, 0, "出勤日", true, true);
                map.AddTBFloat(CHNodeAttr.Scale, 0, "段階比率", true, true);
                map.AddTBFloat(CHNodeAttr.TotalScale, 0, "全体の進捗状況", true, true);
                map.AddTBFloat(CHNodeAttr.ChanZhi, 0, "出力値", true, true);
