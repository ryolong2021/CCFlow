    ...
    public class Delay : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("V_WF_Delay", "期限切れのフロー");
                map.EnType = En.EnType.View;

                map.AddMyPK();

                map.AddTBInt(DelayAttr.WorkID, 0, "ジョブID", true, true);
                map.AddTBString(DelayAttr.FK_Emp, null, "待機人", true, true, 0, 50, 40);
                map.AddTBInt(DelayAttr.FK_Node, 0, "ノード", false, true);

                map.AddTBString(DelayAttr.Title, null, "タイトル", true, true, 0, 50, 100);
                map.AddTBString(DelayAttr.Starter, null, "Starter", false, false, 0, 50, 5);
                map.AddTBString(DelayAttr.StarterName, null, "起票者", true, true, 0, 50, 30);

                map.AddDDLSysEnum(DelayAttr.WFState, 0, "状態", true, true, DelayAttr.WFState);

                map.AddTBInt(DelayAttr.FK_Dept, 0, "所属部署", false, true);
                map.AddTBString(DelayAttr.DeptName, null, "所属部署", true, true, 0, 50, 40);
                map.AddDDLEntities(DelayAttr.FK_Flow, null, "フロー", new Flows(), false);
              //  map.AddTBString(DelayAttr.FlowName, null, "流程名称", true, true, 0, 50, 40);
                map.AddTBString(DelayAttr.NodeName, null, "ノードの名前", true, true, 0, 50, 40);

                map.AddTBInt(DelayAttr.WorkerDept, 0, "スタッフ部門", false, true);
                map.AddTBString(DelayAttr.RDT, null, "受理日", true, true, 0, 50, 30);
                map.AddTBString(DelayAttr.SDT, null, "完了日", true, true, 0, 50, 50);
                map.AddTBInt(DelayAttr.FID, 0, "FID", false, false);
                map.AddTBInt(DelayAttr.FK_FlowSort, 0, "フローカテゴリ", false, true);
               ...
               // map.AddTBString(DelayAttr.SDTOfNode, null, "节点应完成日期", true, true, 0, 50, 70);
                map.AddTBString(DelayAttr.PressTimes, null, "催促する回数", false, true, 0, 50, 5);
                map.AddTBString(DelayAttr.BillNo, null, "伝票番号", true, true, 0, 50, 5);
                map.AddTBString(DelayAttr.FlowNote, null, "FlowNote", false, true, 0, 50, 5);
                map.AddTBString(DelayAttr.TodoEmps, null, "待機人", true, true, 0, 50, 5);
                map.AddTBString(DelayAttr.Sender, null, "送信者", true, true, 0, 50, 50);
