    ...
    public class MyDeptEmp : BP.En.EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Port_Emp", "フローデータ");
                map.Java_SetEnType(EnType.View);

                map.AddTBStringPK(MyDeptEmpAttr.No, null, "番号", false, false, 0, 100, 100);
                map.AddTBString(MyDeptEmpAttr.Name, null, "名前", false, false, 0, 100, 100);
                map.AddTBString(MyDeptEmpAttr.FK_Dept, null, "部門", false, false, 0, 100, 100);
