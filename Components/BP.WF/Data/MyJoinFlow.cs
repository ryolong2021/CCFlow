...
namespace BP.WF.Data
{
	...
	{	
        ...
        public MyJoinFlow(Int64 workId)
        {
            ...
            if (qo.DoQuery() == 0)
                throw new Exception("仕事 MyFlow [" + workId + "]存在しません。");
        }
        /// <summary>
        /// 执行修复
        /// </summary>
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_GenerWorkFlow", "私の承認フロー");
                ...
                map.AddTBString(MyFlowAttr.Title, null, "フローのタイトル", true, false, 0, 100, 150, true);
                map.AddDDLEntities(MyFlowAttr.FK_Flow, null, "フロー名", new Flows(), false);
                map.AddTBString(MyFlowAttr.BillNo, null, "伝票番号", true, false, 0, 100, 50);
                map.AddTBString(MyFlowAttr.StarterName, null, "起票者", true, false, 0, 30, 40);


                map.AddTBDateTime(MyFlowAttr.RDT, "起票日", true, true);
                map.AddDDLSysEnum(MyFlowAttr.WFSta, 0, "状態", true, false, MyFlowAttr.WFSta, "@0=実行中@1 =完了@2 =その他");
                map.AddDDLSysEnum(MyFlowAttr.TSpan, 0, "時間帯", true, false, MyFlowAttr.TSpan, "@0=今週@1=先週@2=2週間前@3=3週間前@4=以前");
                map.AddTBString(MyFlowAttr.NodeName, null, "現在のノード", true, false, 0, 100, 100, true);
                map.AddTBString(MyStartFlowAttr.TodoEmps, null, "現在の処理者", true, false, 0, 100, 100, true);

                map.AddTBString(MyFlowAttr.Emps, null, "参加者", false, false, 0, 4000, 10, true);
                map.AddTBStringDoc(MyFlowAttr.FlowNote, null, "備考", true, false, true);
                map.AddTBDateTime(GenerWorkFlowAttr.SDTOfNode, "ノード完了する時間", true, true);
             ...
             //   map.AddSearchAttr(MyFlowAttr.FK_Flow);
                ...
                //增加隐藏的查询条件. 我参与的流程.
                AttrOfSearch search = new AttrOfSearch(MyFlowAttr.Emps, "人員",
