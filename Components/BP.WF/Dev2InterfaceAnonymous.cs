...
namespace BP.WF
{
    ...
    public class Dev2InterfaceAnonymous
    {
        ...
        {
            if (guestNo == "")
                throw new Exception("@外部ユーザーのタスク情報の設定に失敗しました：パラメーターguestNoは空にできません.");
            if (workID == 0)
                throw new Exception("@外部ユーザーのタスク情報の設定に失敗しました：パラメーターworkIDを0にすることはできません.");
            ...
            if (i == 0)
                throw new Exception("@外部ユーザーのタスク情報の設定に失敗しました：パラメーターworkIDは空にできません.");
            ...
            if (i == 0)
                throw new Exception("@WF_GenerWorkFlow - 外部ユーザーのタスク情報の設定に失敗しました：パラメーターWorkIDは空にできません.");
        }
        #endregion
        ...
        public static string TurnFlowMarkToFlowNo(string FlowMark)
        {
            ...
            if (s == null)
                throw new Exception("@FlowMarkエラー:" + FlowMark + ",フロー番号が見つかりません.");
            return s;
        }
        #endregion
    }
