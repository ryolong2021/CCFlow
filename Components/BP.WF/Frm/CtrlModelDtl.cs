    ...
    public class CtrlModelDtl : BP.En.EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Frm_CtrlModelDtl", "制御モデルテーブルDtl");

                #region 字段
                map.AddMyPK();  //增加一个自动增长的列.

                map.AddTBString(CtrlModelDtlAttr.FrmID, null, "フォームID", true, false, 0, 300, 100);
                //BtnNew,BtnSave,BtnSubmit,BtnDelete,BtnSearch
                map.AddTBString(CtrlModelDtlAttr.CtrlObj, null, "制御権限", true, false, 0, 20, 100);
                //Station,Dept,User
                map.AddTBString(CtrlModelDtlAttr.OrgType, null, "組織タイプ", true, false, 0, 300, 100);
