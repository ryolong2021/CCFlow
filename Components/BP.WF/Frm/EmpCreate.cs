	...
	public class EmpCreate :EntityMM
	{
		...
		public override Map EnMap
		{
            get
            {
                ...
                Map map = new Map("Frm_EmpCreate", "帳票を作成できる人");

                map.AddTBStringPK(EmpCreateAttr.FrmID,null,"フォーム",true,true,1,100,100 );
                map.AddDDLEntitiesPK(EmpCreateAttr.FK_Emp, null, "人員", new Emps(), true);
