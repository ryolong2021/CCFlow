    ...
    public class FrmDeptCreate : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Frm_DeptCreate", "帳票部門");

                map.AddTBStringPK(FrmDeptCreateAttr.FrmID, null, "フォーム", true, true, 1, 100, 100);
                map.AddDDLEntitiesPK(FrmDeptCreateAttr.FK_Dept, null, "部門を作成できます",
