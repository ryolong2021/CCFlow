    ...
    public class StationCreate : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Frm_StationCreate", "帳票部署");

                map.AddTBStringPK(StationCreateAttr.FrmID, null, "フォーム", true, true, 1, 100, 100);
                map.AddDDLEntitiesPK(StationCreateAttr.FK_Station, null, "部署を作成できます",
