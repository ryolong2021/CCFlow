    ...
    public class DeptFlowSearch : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_DeptFlowSearch", "フロー部門データクエリ権限");
                map.AddMyPK();
                map.AddTBString(DeptFlowSearchAttr.FK_Emp, null, "オペレーター", true, true, 1, 50, 11);
                map.AddTBString(DeptFlowSearchAttr.FK_Flow, null, "フロー番号", true, true, 1, 50, 11);
                map.AddTBString(DeptFlowSearchAttr.FK_Dept, null, "部門番号", true, true, 1, 100, 11);
                this._enMap = map;
                return this._enMap;
            }
        }
