	...
	public class Inc:EntityNoName
	{
		...
		public override Map EnMap
		{
            get
            {
                ...
                map.AddTBStringPK(IncAttr.No, null, "ナンバリング", true, false, 1, 30, 40);
                map.AddTBString(IncAttr.ParentNo, null, "親ノード番号", true, false, 0, 30, 40);
                map.AddTBString(IncAttr.Name, null,"名前", true, false, 0, 60, 200,true);
