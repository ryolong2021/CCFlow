    ...
    public class WFEmp : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(WFEmpAttr.AlertWay, 3, "リスニング方法", true, true, WFEmpAttr.AlertWay);
                map.AddTBString(WFEmpAttr.Author, null, "承認者", true, true, 0, 50, 20);
                map.AddTBString(WFEmpAttr.AuthorDate, null, "承認日", true, true, 0, 50, 20);

                //0不授权， 1完全授权，2，指定流程范围授权. 
                map.AddTBInt(WFEmpAttr.AuthorWay, 0, "認可方法", true, true);
                map.AddTBDate(WFEmpAttr.AuthorToDate, null, "これまでの承認", true, true);

                map.AddTBString(WFEmpAttr.AuthorFlows, null, "実行できる承認フロー", true, true, 0, 3900, 0);

                map.AddTBString(WFEmpAttr.Stas, null, "投稿", true, true, 0, 3000, 20);
                ...
                map.AddTBString(WFEmpAttr.SPass, null, "画像署名パスワード", true, true, 0, 200, 20);
