    ...
    public class MapRpt : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_MapData", "レポートのデザイン");

                map.Java_SetDepositaryOfEntity(Depositary.Application);
                map.Java_SetCodeStruct("4"); ;

                map.AddTBStringPK(MapRptAttr.No, null, "ナンバリング", true, false, 1, 200, 20);
                map.AddTBString(MapRptAttr.Name, null, "解説", true, false, 0, 500, 20);
                map.AddTBString(MapRptAttr.PTable, null, "物理的なテーブル", true, false, 0, 500, 20);
                map.AddTBString(MapRptAttr.FK_Flow, null, "フロー番号", true, false, 0, 3, 3);
                ...
                map.AddTBString(MapRptAttr.Note, null, "備考", true, false, 0, 500, 20);


                #region 权限控制. 2014-12-18
                map.AddTBInt(MapRptAttr.RightViewWay, 0, "レポート閲覧許可制御方法", true, false);
                map.AddTBString(MapRptAttr.RightViewTag, null, "レポート表示許可制御タグ", true, false, 0, 4000, 20);
                map.AddTBInt(MapRptAttr.RightDeptWay, 0, "部門データ閲覧制御方法", true, false);
                map.AddTBString(MapRptAttr.RightDeptTag, null, "部門データビューコントロールタグ", true, false, 0, 4000, 20);

                map.AttrsOfOneVSM.Add(new RptStations(), new Stations(), RptStationAttr.FK_Rpt, RptStationAttr.FK_Station,
                    DeptAttr.Name, DeptAttr.No, "位置権限");
                map.AttrsOfOneVSM.Add(new RptDepts(), new Depts(), RptDeptAttr.FK_Rpt, RptDeptAttr.FK_Dept,
                    DeptAttr.Name, DeptAttr.No, "部門権限");
                map.AttrsOfOneVSM.Add(new RptEmps(), new Emps(), RptEmpAttr.FK_Rpt, RptEmpAttr.FK_Emp,
                 DeptAttr.Name, DeptAttr.No, "人員権限");
                #endregion 权限控制.
