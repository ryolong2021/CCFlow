	...
	public class RptDept :Entity
	{
		...
		public override Map EnMap
		{
			get
			{
                ...
                Map map = new Map("Sys_RptDept", "報告部対応情報");
				map.EnType=EnType.Dot2Dot;

                map.AddTBStringPK(RptDeptAttr.FK_Rpt, null, "報告する", false, false, 1, 15, 1);
				map.AddDDLEntitiesPK(RptDeptAttr.FK_Dept,null,"部門",new Depts(),true);
