    ...
    public class RptDfine : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_Flow", "レポート定義");

                map.Java_SetDepositaryOfEntity(Depositary.Application);
                map.Java_SetCodeStruct("4"); ;

                #region 基本属性.
                map.AddTBStringPK(RptDfineAttr.No, null, "ナンバリング", true, false, 1, 200, 20);
                map.AddTBString(RptDfineAttr.Name, null, "フロー名", true, false, 0, 500, 20);

                map.AddDDLSysEnum(RptDfineAttr.MyDeptRole, 0, "この部門が開始したフロー", true,
                    true, RptDfineAttr.MyDeptRole,
                    "@0=部門のリーダーのみが表示できます@1=部門のすべての人が表示できます@2=この部門の指定された位置にいる人が表示できます", true);
                ...
                rm.Warning = "実行してもよろしいですか？実行すると、以前の構成がクリアされます。";
        ...
        public string DoReset(string rptMark, string rptName)
        {
            ...
            return "マーク： "+rptMark + "レポートは正常にリセットされました。";
        }
        #endregion
        ...
        {
            return DoReset("MyDept", "この部門が開始したフロー");
        }
        /// <summary>
        /// 查询
        /// </summary>
        ...
        {
            return DoReset("Adminer", "この部門が開始したフロー");
        }
        /// <summary>
        /// 查询
        /// </summary>
