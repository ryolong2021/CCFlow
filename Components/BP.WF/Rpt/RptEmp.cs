    ...
    public class RptEmp : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_RptEmp", "報告要員の対応情報");
                map.Java_SetEnType(EnType.Dot2Dot);

                map.AddTBStringPK(RptEmpAttr.FK_Rpt, null, "報告する", false, false, 1, 15, 1);
                map.AddDDLEntitiesPK(RptEmpAttr.FK_Emp, null, "人事", new Emps(), true);
