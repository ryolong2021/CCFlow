    ...
    public class RptStation : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_RptStation", "レポート投稿対応情報");

                map.Java_SetEnType(EnType.Dot2Dot);

                map.AddTBStringPK(RptStationAttr.FK_Rpt, null, "報告する", false, false, 1, 15, 1);
                map.AddDDLEntitiesPK(RptStationAttr.FK_Station, null, "役職", new Stations(), true);
