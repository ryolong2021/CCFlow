    ...
    public class AccepterRole : EntityOID
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_AccepterRole", "受信者のルール");

                map.AddTBIntPKOID();

                map.AddTBString(AccepterRoleAttr.Name, null, null, true, false, 0, 200, 10, true);
                map.AddTBString(AccepterRoleAttr.FK_Node, null, "ノード", false, true, 0, 100, 10);
                map.AddTBInt(AccepterRoleAttr.FK_Mode, 0, "パターンタイプ", false, true);
