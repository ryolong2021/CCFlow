    ...
    public class BtnLabExtWebOffice : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_Node", "ドキュメント属性制御");

                map.Java_SetDepositaryOfEntity(Depositary.Application);

                map.AddTBIntPK(BtnAttr.NodeID, 0, "ノードID", true, true);
                map.AddTBString(BtnAttr.Name, null, "ノード名", true, true, 0, 100, 10);


                #region 公文按钮
                map.AddTBString(BtnAttr.OfficeOpen, "ローカルを開く", "ローカルを開くラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeOpenEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeOpenTemplate, "テンプレートを開く", "テンプレートを開くラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeOpenTemplateEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeSave, "保存する", "保存するラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeSaveEnable, true, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeAccept, "改訂を承認", "改訂を承認ラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeAcceptEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeRefuse, "改訂を拒否", "改訂を拒否ラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeRefuseEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeOver, "赤いボタンのセット", "赤いボタンのセットラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeOverEnable, false, "有効にするかどうか", true, true);

                map.AddBoolean(BtnAttr.OfficeMarks, true, "ユーザートレースをチェックするかどうか", true, true);
                map.AddBoolean(BtnAttr.OfficeReadOnly, false, "読み取り専用", true, true);

                map.AddTBString(BtnAttr.OfficePrint, "印刷ボタン", "印刷ボタンラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficePrintEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeSeal, "サインボタン", "サインボタンラベル", true, false, 0, 50, 10);
                map.AddBoolean(BtnAttr.OfficeSealEnable, false, "有効にするかどうか", true, true);

                map.AddTBString(BtnAttr.OfficeInsertFlow, "挿入フロー", "挿入フローラベル", true, false, 0, 50, 10);
                ...
                map.AddTBString(BtnAttr.OfficeDownLab, "ダウンロード", "ダウンロードボタンのラベル", true, false, 0, 50, 10);
                ...
                map.AddTBString(BtnAttr.OfficeTemplate, "", "ドキュメントテンプレートを指定", true, false, 0, 50, 10);

                map.AddBoolean(BtnAttr.OfficeIsParent, true, "親フローのドキュメントを使用するかどうか", true, true);

             

                map.AddBoolean(BtnAttr.OfficeIsTrueTH, false, "自動的に裁定取引を行うかどうか", true, true);
                map.AddTBString(BtnAttr.OfficeTHTemplate, "", "自動赤テンプレート", true, false, 0, 50, 10);

                map.AddTBString(BtnAttr.WebOfficeLab, "公式文書", "公式文書ラベル", true, false, 0, 50, 10);
                ...
                map.AddDDLSysEnum(BtnAttr.WebOfficeFrmModel, 0, "フォームの仕組み", true, true, "FrmType");
