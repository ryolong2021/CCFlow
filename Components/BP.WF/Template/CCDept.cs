	...
	public class CCDept :EntityMM
	{
		...
		public override Map EnMap
		{
			get
			{
                ...
                Map map = new Map("WF_CCDept", "CC部門");				 

				map.AddDDLEntitiesPK(CCDeptAttr.FK_Node,0,DataType.AppInt,"ノード",new Nodes(),NodeAttr.NodeID,NodeAttr.Name,true);
				map.AddDDLEntitiesPK( CCDeptAttr.FK_Dept,null,"部門",new Depts(),true);
				this._enMap=map;
				return this._enMap;
			}
		}
