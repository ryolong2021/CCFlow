    ...
    public class CCStation : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_CCStation", "CC投稿");

                map.AddDDLEntitiesPK(CCStationAttr.FK_Node, 0, DataType.AppInt, "ノード", new Nodes(), NodeAttr.NodeID, NodeAttr.Name, true);
                map.AddDDLEntitiesPK(CCStationAttr.FK_Station, null, "役職", new Stations(), true);
