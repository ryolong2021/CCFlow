    ...
    public class DirectionStation : EntityMM
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_DirectionStation", "ノードポスト");

                map.AddTBIntPK(DirectionStationAttr.FK_Direction, 0,"ノード", false,false);

                if (BP.WF.Glo.OSModel == BP.Sys.OSModel.OneOne)
                {
                    map.AddDDLEntitiesPK(DirectionStationAttr.FK_Station, null, "役職",
