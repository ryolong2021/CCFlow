    ...
    public class DocTemplate : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                if (this._enMap != null)
                    return this._enMap;
                Map map = new Map("WF_DocTemplate", "公式文書テンプレート");

                map.Java_SetCodeStruct("6");

                map.AddTBStringPK(DocTemplateAttr.No, null, "No", true, true, 6, 6, 20);
                map.AddTBString(DocTemplateAttr.Name, null, "名前", true, false, 0, 200, 20);
                map.AddTBString(DocTemplateAttr.TempFilePath, null, "テンプレートのパス", true, false, 0, 200, 20);
