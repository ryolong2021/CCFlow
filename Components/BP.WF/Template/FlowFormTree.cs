    ...
    public class FlowFormTree : EntityTree
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_FormTree", "独立したフォームツリー-データ分解構築用");
                map.Java_SetCodeStruct("2");;
                map.Java_SetDepositaryOfEntity(Depositary.Application);


                map.AddTBStringPK(FlowFormTreeAttr.No, null, "ナンバリング", true, true, 1, 10, 20);
                map.AddTBString(FlowFormTreeAttr.Name, null, "名前", true, false, 0, 100, 30);
                map.AddTBString(FlowFormTreeAttr.ParentNo, null, "親ノードいいえ", false, false, 0, 100, 30);
                map.AddTBInt(FlowFormTreeAttr.Idx, 0, "Idx", false, false);

                // 隶属的流程编号.
                map.AddTBString(FlowFormTreeAttr.FK_Flow, null, "フロー番号", true, true, 1, 20, 20);
