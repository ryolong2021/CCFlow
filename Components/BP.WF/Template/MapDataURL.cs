    ...
    public class MapDataURL : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("Sys_MapData", "URLフォーム属性");
                ...
                map.AddTBString(MapDataAttr.PTable, null, "収納テーブル", false, false, 0, 500, 20);

                map.AddTBString(MapDataAttr.Url, null, "URL接続", true, false, 0, 500, 20, true);
