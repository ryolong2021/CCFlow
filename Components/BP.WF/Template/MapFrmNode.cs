    ...
    public class MapFrmNode : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                #region 基本属性.
                map.AddTBStringPK(MapFrmNodeAttr.No, null, "フォーム番号", true, true, 1, 190, 20);
                map.AddTBString(MapFrmNodeAttr.PTable, null, "収納テーブル", true, false, 0, 100, 20);
                map.AddTBString(MapFrmNodeAttr.Name, null, "フォーム名", true, false, 0, 200, 20,true);
                map.AddTBString(MapDataAttr.FormEventEntity, null, "イベントエンティティ", true, true, 0, 100, 20, true);
                 
                //数据源.
                map.AddDDLEntities(MapFrmNodeAttr.DBSrc, "local", "情報源", new BP.Sys.SFDBSrcs(), true);

                //宽度高度.
                map.AddTBInt(MapFrmNodeAttr.FrmW, 900, "幅", true, false);
                map.AddTBInt(MapFrmNodeAttr.FrmH, 1200, "高さ", true, false);

                //表单的运行类型.
                map.AddDDLSysEnum(MapFrmNodeAttr.FrmType, (int)BP.Sys.FrmType.FreeFrm, "フォームタイプ", true, false, MapFrmNodeAttr.FrmType);
                #endregion 基本属性.

                #region 设计者信息.
                map.AddTBString(MapFrmNodeAttr.Designer, null, "デザイナー", true, false, 0, 500, 20);
                map.AddTBString(MapFrmNodeAttr.DesignerContact, null, "連絡先", true, false, 0, 500, 20);
                map.AddTBString(MapFrmNodeAttr.DesignerUnit, null, "単位", true, false, 0, 500, 20, false);
                map.AddTBString(MapFrmNodeAttr.GUID, null, "GUID", true, true, 0, 128, 20, false);
                map.AddTBString(MapFrmNodeAttr.Ver, null, "バージョンナンバー", true, true, 0, 30, 20);
                map.AddTBStringDoc(MapFrmNodeAttr.Note, null, "備考", true, false, true);

                //增加参数字段.
                map.AddTBAtParas(4000);
                map.AddTBInt(MapFrmNodeAttr.Idx, 100, "シーケンス番号", false, false);
                #endregion 设计者信息.
