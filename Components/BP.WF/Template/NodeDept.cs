	...
	public class NodeDept :EntityMM
	{
		...
		public override Map EnMap
		{
			get
			{
                ...
                Map map = new Map("WF_NodeDept", "ノード部門");			 
                ...
                map.AddTBIntPK(NodeStationAttr.FK_Node, 0, "ノード", false, false);

                //map.AddDDLEntitiesPK(NodeDeptAttr.FK_Node,0,DataType.AppInt,"节点",new Nodes(),
                //    NodeAttr.NodeID,NodeAttr.Name,true);

				map.AddDDLEntitiesPK( NodeDeptAttr.FK_Dept,null,"部門",new BP.Port.Depts(),true);
