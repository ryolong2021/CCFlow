    ...
    public class NodeSheet : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(NodeAttr.Name, null, "名前", true, true, 0, 100, 10, false, "http://ccbpm.mydoc.io/?v=5404&t=17903");
                #endregion  基础属性
                ...
                map.AttrsOfOneVSM.AddGroupPanelModel(new BP.WF.Template.NodeStations(), new BP.WF.Port.Stations(),
                    ...
                    BP.WF.Template.NodeStationAttr.FK_Station, "ノードバインディングポスト", StationAttr.FK_StationType);

                map.AttrsOfOneVSM.AddGroupListModel(new BP.WF.Template.NodeStations(), new BP.WF.Port.Stations(),
                  BP.WF.Template.NodeStationAttr.FK_Node,
                  BP.WF.Template.NodeStationAttr.FK_Station, "ノードバインディングポストAddGroupListModel", StationAttr.FK_StationType);


                //节点绑定部门. 节点绑定部门.
                map.AttrsOfOneVSM.AddBranches(new BP.WF.Template.NodeDepts(), new BP.Port.Depts(),
                   BP.WF.Template.NodeDeptAttr.FK_Node,
                   BP.WF.Template.NodeDeptAttr.FK_Dept, "ノードバインディング部門AddBranches", EmpAttr.Name, EmpAttr.No, "@WebUser.FK_Dept");


                //节点绑定人员. 使用树杆与叶子的模式绑定.
                map.AttrsOfOneVSM.AddBranchesAndLeaf(new BP.WF.Template.NodeEmps(), new BP.Port.Emps(),
                   BP.WF.Template.NodeEmpAttr.FK_Node,
                   BP.WF.Template.NodeEmpAttr.FK_Emp, "ノードバインディング受信者", EmpAttr.FK_Dept, EmpAttr.Name, EmpAttr.No, "@WebUser.FK_Dept");
