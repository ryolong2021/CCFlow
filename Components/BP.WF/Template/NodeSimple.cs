    ...
    public class NodeSimple : Entity
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(NodeAttr.FK_Flow, null, "フロー番号", true, false, 0, 150, 10);
                map.AddTBInt(NodeAttr.RunModel, 0, "動作モード", true, true);
                map.AddTBInt(NodeAttr.Step, 0, "手順", true, true);
                #endregion 基本属性.
