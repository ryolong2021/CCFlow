    ...
    public class SysFormTree : EntityTree
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBStringPK(SysFormTreeAttr.No, null, "ナンバリング", true, true, 1, 10, 20);
                map.AddTBString(SysFormTreeAttr.Name, null, "名前", true, false, 0, 100, 30);
                map.AddTBString(SysFormTreeAttr.ParentNo, null, "親ノードNo", false, false, 0, 100, 30);
