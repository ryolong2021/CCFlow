    ...
    public class TestCase : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_TestCase", "カスタムフローテスト");

                map.AddMyPK();
                map.AddTBString(TestCaseDtlAttr.FK_Flow, null, "フロー番号", true, false, 0, 100, 100, true);
                map.AddTBString(TestCaseDtlAttr.ParaType, null, "パラメータのタイプ", true, false, 0, 100, 100, true);
                map.AddTBString(TestCaseDtlAttr.Vals, null, "値s", true, false, 0, 500, 300, true);
                this._enMap = map;
                return this._enMap;
            }
        }
