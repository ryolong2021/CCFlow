    ...
    public class TruckViewPower : EntityNoName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_Flow", "フローテンプレートマスターテーブル");

                map.Java_SetDepositaryOfEntity(Depositary.Application);


                map.AddTBStringPK(TruckViewPowerAttr.No, null, "ナンバリング", true, true, 1, 10, 3);
                map.AddTBString(TruckViewPowerAttr.Name, null, "名前", true, false, 0, 50, 10, true);


                #region 权限控制. 此部分与流程属性同步.
                map.AddBoolean(TruckViewPowerAttr.PStarter, true, "イニシエーターは見ることができます（必須）", true, false, true);
                map.AddBoolean(TruckViewPowerAttr.PWorker, true, "参加者は見ることができます（必須）", true, false, true);
                map.AddBoolean(TruckViewPowerAttr.PCCer, true, "Ccを表示できます（必須）", true, false, true);

                map.AddBoolean(TruckViewPowerAttr.PMyDept, true, "この部門の人々は見ることができます", true, true, true);
                map.AddBoolean(TruckViewPowerAttr.PPMyDept, true, "直属の上司から見ることができる（例：私は）", true, true, true);

                map.AddBoolean(TruckViewPowerAttr.PPDept, true, "上位部門で閲覧可能", true, true, true);
                map.AddBoolean(TruckViewPowerAttr.PSameDept, true, "ピア部門で見ることができます", true, true, true);

                map.AddBoolean(TruckViewPowerAttr.PSpecDept, true, "指定部門で閲覧可能", true, true, false);
                map.AddTBString(TruckViewPowerAttr.PSpecDeptExt, null, "部門番号", true, false, 0, 200, 100, false);


                map.AddBoolean(TruckViewPowerAttr.PSpecSta, true, "指定された位置を見ることができます", true, true, false);
                map.AddTBString(TruckViewPowerAttr.PSpecStaExt, null, "投稿番号", true, false, 0, 200, 100, false);

                map.AddBoolean(TruckViewPowerAttr.PSpecGroup, true, "指定した許可グループを表示できます", true, true, false);
                map.AddTBString(TruckViewPowerAttr.PSpecGroupExt, null, "権利グループ", true, false, 0, 200, 100, false);

                map.AddBoolean(TruckViewPowerAttr.PSpecEmp, true, "指定された担当者が見ることができます", true, true, false);
                map.AddTBString(TruckViewPowerAttr.PSpecEmpExt, null, "指定職員番号", true, false, 0, 200, 100, false);
                #endregion 权限控制.
