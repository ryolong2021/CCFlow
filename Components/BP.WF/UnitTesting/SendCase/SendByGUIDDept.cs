...
namespace BP.UnitTesting.SendCase
{
    ...
    public class SendByGUIDDept : TestBase
    {
        ...
        public void ReLoadDept()
        {
            ...
            string sqlscript = "";
            sqlscript = BP.Sys.SystemConfig.PathOfData + Path.DirectorySeparatorChar + "Install" + Path.DirectorySeparatorChar + "SQLScript" + Path.DirectorySeparatorChar + "Port_Inc_CH_BMP.sql";
