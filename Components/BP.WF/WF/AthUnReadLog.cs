    ...
    public class AthUnReadLog : EntityMyPK
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_AthUnReadLog", "添付ファイルの未読ログ");
               ...
               // map.AddDDLEntities(GenerWorkFlowAttr.FK_NY, null, "年月", new BP.Pub.NYs(), false);
                map.AddDDLEntities(GenerWorkFlowAttr.FK_Flow, null, "処理する", new Flows(), false);


                map.AddTBInt(AthUnReadLogAttr.FK_Node, 0, "ノードID", true, true);
                map.AddTBString(AthUnReadLogAttr.NodeName, null, "ノード名", true, true, 0, 20, 10);

                //删除信息.
                map.AddTBString(AthUnReadLogAttr.FK_Emp, null, "人事", true, true, 0, 20, 10);
                map.AddTBString(AthUnReadLogAttr.FK_EmpDept, null, "人事部", true, true, 0, 20, 10);
                map.AddTBString(AthUnReadLogAttr.FK_EmpDeptName, null, "人名", true, true, 0, 200, 10);
                map.AddTBString(AthUnReadLogAttr.BeiZhu, "", "コンテンツ", true, true, 0, 4000, 10);
                map.AddTBDateTime(AthUnReadLogAttr.SendDT, null, "日付", true, true);
