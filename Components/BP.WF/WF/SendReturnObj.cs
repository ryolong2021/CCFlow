...
namespace BP.WF
{
    ...
    public class SendReturnObj
    {
        ...
        public string MsgFlagDesc
        {
            ...
            {
                if (MsgFlag == null)
                    throw new Exception("@マークされていません");
