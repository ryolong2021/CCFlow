	...
	{		
        ...
        public override Map EnMap
        {
            get
            {
                ...
                Map map = new Map("WF_ShiftWork", "引渡実績");

                map.AddMyPK();

                map.AddTBInt(ShiftWorkAttr.WorkID, 0, "ジョブID", true, true);
                map.AddTBInt(ShiftWorkAttr.FK_Node, 0, "FK_Node", true, true);
                map.AddTBString(ShiftWorkAttr.FK_Emp, null, "引き渡す", true, true, 0, 40, 10);
                map.AddTBString(ShiftWorkAttr.FK_EmpName, null, "譲渡人の名前", true, true, 0, 40, 10);

                map.AddTBString(ShiftWorkAttr.ToEmp, null, "引き渡す", true, true, 0, 40, 10);
                map.AddTBString(ShiftWorkAttr.ToEmpName, null, "引渡し名", true, true, 0, 40, 10);

                map.AddTBDateTime(ShiftWorkAttr.RDT, null, "引渡時間", true, true);
                map.AddTBString(ShiftWorkAttr.Note, null, "引渡理由", true, true, 0, 2000, 10);

                map.AddTBInt(ShiftWorkAttr.IsRead, 0, "それを読んで？", true, true);
                this._enMap = map;
                return this._enMap;
            }
        }
